...
import { EventLLMMessageOnTextParams, EventLLMMessageOnErrorParams, EventLLMMessageOnFinalMessageParams, EventLLMMessageOnCliToolEventParams, MainSendLLMMessageParams, AbortRef, SendLLMMessageParams, MainLLMMessageAbortParams, ModelListParams, EventModelListOnSuccessParams, EventModelListOnErrorParams, OllamaModelResponse, OpenaiCompatibleModelResponse, MainModelListParams, } from '../common/sendLLMMessageTypes.js';
...
export class LLMMessageChannel implements IServerChannel {
	...
	private readonly llmMessageEmitters = {
		...
		onCliToolEvent: new Emitter<EventLLMMessageOnCliToolEventParams>(),
	}
	...
	listen(_: unknown, event: string): Event<any> {
		...
		else if (event === 'onCliToolEvent_sendLLMMessage') return this.llmMessageEmitters.onCliToolEvent.event;
		// list
	...
	private _callSendLLMMessage(params: MainSendLLMMessageParams) {
		...
		const mainThreadParams: SendLLMMessageParams = {
			...
			onCliToolEvent: (p) => {
				this.llmMessageEmitters.onCliToolEvent.fire({ requestId, ...p });
			},
